...
<div class="why-strip">
  ...
  <div class="why-grid">
    <div class="why-item"><span class="why-num">冷与热</span><h3>冷热交替疗法，用心以待</h3><p>矿物温泉的暖热与冰浴的冷冽，同处一间私密房间之中——这项恢复仪式正重新受到全球关注，在这里，我们视其为一种专注的修行，而非噱头。</p></div>
    <div class="why-item"><span class="why-num">私密</span><h3>只属于您</h3><p>没有共用浴场，没有排队等候。每间房都完全属于您——无论是两人时光，还是最多三位亲友共享。</p></div>
    <div class="why-item"><span class="why-num">工艺</span><h3>静谧而讲究的细节</h3><p>真正的矿物盐水与臻选材质，一切选择只为真实的恢复效果，而非为了迎合镜头。</p></div>
  </div>
</div>
<section class="section" id="menu">
  ...
  <div class="cards">
    ...
    <div class="card">
      <div class="thumb"><img src="{signature_card}" alt="Zenva signature spa treatment tray" loading="lazy"></div>
      <div class="body"><span class="kicker">全面恢复</span><h3>SPA与按摩系列</h3>
...
<div class="blog-hero">
  ...
  <h1>关于休息、恢复与静谧仪式的札记</h1>
  <p>关于温泉沐浴、冷热交替疗法与日常恢复仪式的分享与实用心得——无论您是否已是Zenva的常客，这里都欢迎每一位对这个世界心怀好奇的人。</p>
</div>
<section class="section">
  <div class="blog-grid">
    ...
    """ + blog_card_zh("养生指南", "在曼谷挑选私人温泉：真正重要的事",
                     ...
                     "room_bonsai", "blog-choosing-private-onsen-bangkok.html") + """
    """ + blog_card_zh("养生与恢复", "温泉体验前后：简明的护理指南",
...
with open("/tmp/zenva_site/zh/blog.html", "w") as f:
    f.write(page("Zenva养生日志——养生与恢复指南", "blog", zh_blog_body, blog_extra_css,
...
<div class="article-hero">
  ...
  <div class="meta">Zenva养生日志 &middot; 养生与恢复</div>
</div>
<div class="article-body">
  <p class="lead">冷热交替疗法——在热水浸浴与低温刺激之间交替进行——已成为养生圈中备受讨论的恢复方式之一。在Zenva，这正是我们私人温泉房的核心理念：一池富含矿物盐的暖汤温泉，搭配一池冰浴，私密进行，全凭您自己的节奏。</p>
  ...
  <h3>与SPA护理的搭配</h3>
  <p>冷热循环之后，肌肉会处于温热、放松且更易被按摩深入舒缓的状态——这也是为什么我们将双人与单人套餐设计为在温泉体验后紧接芳香精油按摩或泰式按摩，而非将两者视为独立的两次到访。这正是我们"全面恢复体验"定位背后的理念：冷热仪式负责循环与焕新，按摩则负责后续的肌肉舒缓。</p>
